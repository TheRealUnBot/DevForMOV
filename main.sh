...
case $ans in
  ...
  5 ) git init; git add .; git commit -m 'test'; git remote set-url origin https://TheRealUnBot:$KEY_GIT@github.com/TheRealUnBot/DevForMOV.git; git push -u origin master; exit;;
esac