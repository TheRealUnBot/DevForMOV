...
case $ans in
  ...
  4 ) echo Compiling Client...; sh gradlew teavmc; echo Compiled classes.js; echo Compiling EPK...; java -jar epkcompiler/CompilePackage.jar "resources" "output/assets.epk"; echo Compiled EPK; echo Starting Server for Testing...; cd output; webfsd -F -p 8000; exit;;
  3 ) echo Starting Server for Testing...; cd output; webfsd -F -p 8000; exit;;
