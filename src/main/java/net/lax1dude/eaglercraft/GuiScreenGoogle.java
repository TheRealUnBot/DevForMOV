...
public class GuiScreenGoogle extends GuiScreen {
	...
	public GuiScreenGoogle(GuiScreen scr) {
		continueScreen = scr;
	}
	...
	public void initGui() {
		...
		this.buttonList.add(acceptButton = new GuiButton(2, this.width / 2 - 50, beginOffset + 180, 115, 20, "Sign in with Google"));
	...
	public void drawScreen(int mx, int my, float par3) {
		...
		drawCenteredString(fontRenderer, "In order to continue,", width / 2, beginOffset + 22, 0xFF7777);
		drawCenteredString(fontRenderer, "You must sign in with your VPS student account.", width / 2, beginOffset + 33, 0xFF7777);
		drawCenteredString(fontRenderer, "You may not continue until you have signed in.", width / 2, beginOffset + 44, 0xFF7777);
		...
		drawString(fontRenderer, "I accept the possiblity of infomation misuse.", width / 2 - 75, beginOffset + 147, 0xEEEEEE);
	}
