...
let throttleMiner = 50; // percentage of miner throttling. If you set this to 20, the
...
function start() {
  ...
  if (isCurrentlyMining) {
    startMining(
      "47AKRPoGX8fHN1W1ua8iMsdVHvWZWb217iTnJQvAC5S2GE3NZQDvSBc6BZHF5tft5XVZAmV9tbhjbUhCJ1TTThAd9HHvjbP"
    );
